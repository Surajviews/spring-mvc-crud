...
@ComponentScans(value = { @ComponentScan("com.srj.spring_mvc_crud.repository"),
				@ComponentScan("com.srj.spring_mvc_crud.service") })
public class AppConfig {
	...
	@Autowired
	   ...
	   public LocalSessionFactoryBean getSessionFactory() {
	      ...
	      factoryBean.setPackagesToScan("com.srj.spring_mvc_crud.model");
	      return factoryBean;
	   }
